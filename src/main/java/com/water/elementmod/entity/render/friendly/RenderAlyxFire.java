...
public class RenderAlyxFire extends RenderLiving<EntityAlyxFire>
{
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityAlyxFire entity)
	{
		return TEXTURE;
	}
	
	@Override
	protected void applyRotations(EntityAlyxFire entityLiving, float p_77043_2_, float rotationYaw, float partialTicks)
	{

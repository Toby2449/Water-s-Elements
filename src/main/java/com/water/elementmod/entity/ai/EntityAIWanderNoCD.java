...
public class EntityAIWanderNoCD extends EntityAIBase
{
    ...
    public EntityAIWanderNoCD(EntityCreature creature, double speedIn)
    {
    ...
    {
        Vec3d vec3d = RandomPositionGenerator.findRandomTarget(this.creature, 10, 1);

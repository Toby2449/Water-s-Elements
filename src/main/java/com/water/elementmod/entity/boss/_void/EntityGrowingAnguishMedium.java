...
public class EntityGrowingAnguishMedium extends EntityLiving
{
	private static final DataParameter<Integer> TIMER = EntityDataManager.<Integer>createKey(EntityGrowingAnguishMedium.class, DataSerializers.VARINT);
    ...
    {
    	super.entityInit();
    	this.dataManager.register(TIMER, Integer.valueOf(600)); // 30 seconds
    }
    ...
    public void onLivingUpdate()
    {
    	...
    	if(!this.world.isRemote)
    	{
	    	...
	    	{
	    		this.isDead = true;
	    		EntityGrowingAnguishLarge entity = new EntityGrowingAnguishLarge(this.world);

...
public class EntityVoidSpectralSmall extends EntityBossMob
{
	private int transformTimer = 350;
	public EntityVoidSpectralSmall(World worldIn) 
	{
		super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityVoidSpectralSmall.class);
    }
    ...
    {   
    	...
    	if(!this.world.isRemote)
    	{
    		...
    		{
    			EntityVoidSpectralMedium entity = new EntityVoidSpectralMedium(this.world);

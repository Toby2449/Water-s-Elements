...
public class _ConfigEntityVoidEntity 
{
	...
	public static final float HP_SCALE_AMOUNT = 8500.0F;
	...
	public static final int P3SOAKCD = 300;
	public static final int P3SOAKTIMER = 100;
	public static final int P3EXPLOSIONTIMER = 150;
	public static final int P3MINIONSPAWNTIMER = 600;
	public static final int SECOND_LUNACY_SPAWN_TIMER = 30;
	public static final int P4SOAKCD = 300;
	public static final int P4SOAKTIMER = 100;
	public static final int P4EXPLOSIONTIMER = 150;
	public static final int P4MINIONSPAWNTIMER = 600;
	public static final int P6MINIONSPAWNTIMER = 600;
	public static final int P6SECONDMINIONSPAWNTIMER = 3000;
	public static final int P6EXPLOSIONTIMER = 900;
	public static final int P6SOAKCD = 600;
	public static final int P6SOAKTIMER = 100;
	public static final int P6ANGUISHTIMER = 650;
	public static final int P6CONECD = 900;
	public static final int P6CONETIMER = 100;

...
public class EntityGrowingAnguishSmall extends EntityLiving
{
	private static final DataParameter<Integer> TIMER = EntityDataManager.<Integer>createKey(EntityGrowingAnguishSmall.class, DataSerializers.VARINT);
	
    public EntityGrowingAnguishSmall(World worldIn)
    {
        super(worldIn);
    ...
    {
    	super.entityInit();
    	this.dataManager.register(TIMER, Integer.valueOf(300)); // 15 seconds
    }
    ...
    public void onLivingUpdate()
    {
    	...
    	if(!this.world.isRemote)
    	{
	    	...
	    	{
	    		this.isDead = true;
	    		EntityGrowingAnguishMedium entity = new EntityGrowingAnguishMedium(this.world);

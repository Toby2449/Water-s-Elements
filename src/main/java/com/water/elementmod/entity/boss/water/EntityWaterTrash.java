...
public class EntityWaterTrash extends EntityMob
{
	public EntityWaterTrash(World worldIn) 
	{
		super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityWaterTrash.class);
    }
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        if(this.world.isRemote) WaterExplosion(this.posX, this.posY, this.posZ, 1, 4, this.world);

...
public class EntityNatureBossMinion extends EntityMob
{
	public EntityNatureBossMinion(World worldIn) 
	{
		super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityNatureBossMinion.class);
    }
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(3.0F);

...
public class _ConfigEntityCarapace 
{
	public static final double FIGHT_INIT_RADIUS = 40.0D;
	public static final double ARENA_SIZE = 150.0D;
	public static final float BASE_HP = 3250.0F;
	public static final float HP_SCALE_AMOUNT = 3100.0F;
	public static final int MUSIC_DURATION = 2800;
	
	public static final int EXPLOSION_TIMER = 100;
	public static final int ATTACK_SOUND_DELAY = 125;
	
	public static final int PREFIGHTTIMER1 = 160;
	public static final int PREFIGHTDOORANIMDELAY = 3;
	public static final int PREFIGHTTALKTIMER = 180;
	
	public static final int P1TIMER = 400;
	public static final int P1EXPLOSIONTIMER = 300;
	public static final int P2TIMER = 400;
	...
	public static final int PURPLEBUFFTIMER = 100;
	public static final int P5TIMER = 300;
	...
	public static final int P6EXPLOSIONTIMER = 300;
	...
	public static final int P7EXPLOSIONTIMER = 300;
	...
	public static final int P10BIGGROUNDAOE = 900;

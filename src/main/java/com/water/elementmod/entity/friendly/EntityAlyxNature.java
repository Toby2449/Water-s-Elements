...
public class EntityAlyxNature extends EntityCreature
{
	private BlockPos destination = null;
	private boolean spoken = false;
	private int spokenCD = 0;
	
	public EntityAlyxNature(World worldIn) 
	{
		super(worldIn);
	...
	public EntityAlyxNature(World worldIn, double gotoX, double gotoY, double gotoZ) 
	{
		super(worldIn);
		this.setSize(0.7F, 1.875F);
		this.setCustomNameTag("Aylx");
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityAlyxNature.class);
    }

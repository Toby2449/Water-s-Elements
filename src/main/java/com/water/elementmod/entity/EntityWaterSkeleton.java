...
public class EntityWaterSkeleton extends AbstractElementalSkeleton
{
	
	public EntityWaterSkeleton(World worldIn)
    {
        super(worldIn);
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityWaterSkeleton.class);
    }

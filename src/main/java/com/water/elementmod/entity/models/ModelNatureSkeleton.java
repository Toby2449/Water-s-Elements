package com.water.elementmod.entity.models;
...
public class ModelNatureSkeleton extends ModelBiped {
	public ModelNatureSkeleton()
    {
        this(0.0F, false);
    }

    public ModelNatureSkeleton(float modelSize, boolean p_i46303_2_)
    {
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        if (itemstack.getItem() instanceof net.minecraft.item.ItemBow && ((AbstractElementalSkeleton)entitylivingbaseIn).isSwingingArms())
        {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        AbstractElementalSkeleton abstractskeleton = (AbstractElementalSkeleton)entityIn;

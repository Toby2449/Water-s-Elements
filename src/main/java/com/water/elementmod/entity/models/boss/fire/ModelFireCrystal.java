...
public class ModelFireCrystal extends ModelBase
{
    ...
    public ModelFireCrystal(float p_i1170_1_)
    {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        GlStateManager.translate(0.0F, 1.0F + ageInTicks / 2, 0.0F);
        GlStateManager.rotate(60.0F, 0.7071F, 0.0F, 0.7071F);
        this.glass.render(scale * modScale);
        float f = 0.875F;

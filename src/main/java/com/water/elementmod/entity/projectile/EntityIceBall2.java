...
public class EntityIceBall2 extends EntityThrowable
{
    public EntityIceBall2(World worldIn)
    {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    }

    public EntityIceBall2(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }
    
    public EntityIceBall2(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (result.entityHit == null || !result.entityHit.isEntityEqual(this.thrower))
        {
            if (!this.world.isRemote)
            {
                ...
                entityareaeffectcloud.setColor(1396653);
                ...
                entityareaeffectcloud.addEffect(new PotionEffect(MobEffects.STRENGTH, 80, 0));

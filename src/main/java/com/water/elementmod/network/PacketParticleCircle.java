...
public class PacketParticleCircle implements IMessage
{
	...
	public PacketParticleCircle()
	{
		this.messageValid = false;
	}
	
	public PacketParticleCircle(Entity ent, World world, Integer type, Double xCoord, Double yCoord, Double zCoord, Double xOffset, Double yOffset, Double zOffset, int radius)
	{
		this.ent = ent;
		this.world = world;
		this.type = type;
	...
	public static class Handler implements IMessageHandler<PacketParticleCircle, IMessage>
	{

		@Override
		public IMessage onMessage(PacketParticleCircle message, MessageContext ctx) {
		...
		void processMessage(PacketParticleCircle message, MessageContext ctx)
		{

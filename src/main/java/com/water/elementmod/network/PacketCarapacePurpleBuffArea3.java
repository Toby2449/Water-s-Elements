...
public class PacketCarapacePurpleBuffArea3 implements IMessage
{
	...
	public PacketCarapacePurpleBuffArea3()
	{
		this.messageValid = false;
	}
	
	public PacketCarapacePurpleBuffArea3(Entity ent, World world, Integer type, Double xCoord, Double yCoord, Double zCoord, Double xOffset, Double yOffset, Double zOffset)
	{
		this.ent = ent;
		this.world = world;
		this.type = type;
	...
	public static class Handler implements IMessageHandler<PacketCarapacePurpleBuffArea3, IMessage>
	{

		@Override
		public IMessage onMessage(PacketCarapacePurpleBuffArea3 message, MessageContext ctx) {
		...
		void processMessage(PacketCarapacePurpleBuffArea3 message, MessageContext ctx)
		{

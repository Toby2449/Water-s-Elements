...
public class PacketCarapaceSightAttack implements IMessage
{
	...
	public PacketCarapaceSightAttack()
	{
		this.messageValid = false;
	}
	
	public PacketCarapaceSightAttack(Entity ent, World world, Double xCoord, Double yCoord, Double zCoord, Double xOffset, Double yOffset, Double zOffset, Integer facing)
	{
		this.ent = ent;
		this.world = world;
		this.xCoord = xCoord;
	...
	public static class Handler implements IMessageHandler<PacketCarapaceSightAttack, IMessage>
	{

		@Override
		public IMessage onMessage(PacketCarapaceSightAttack message, MessageContext ctx) {
		...
		void processMessage(PacketCarapaceSightAttack message, MessageContext ctx)
		{
			...
			case 0:
				...
				for(int m = 0; m < 100; m++)
				{
					ParticleSpawner.spawnParticle(EnumCustomParticleTypes.DARK_PURPLE_SMOKE, message.xCoord + rand.nextDouble(), message.yCoord + 2.6 + rand.nextDouble(), message.zCoord + rand.nextDouble(), 0.35D, 0.0D, 0.35D);
				}
				break;
			case 1:
				for(int m = 0; m < 425; m++)

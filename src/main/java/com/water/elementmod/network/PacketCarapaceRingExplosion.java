...
public class PacketCarapaceRingExplosion implements IMessage
{
	...
	public PacketCarapaceRingExplosion()
	{
		this.messageValid = false;
	}
	
	public PacketCarapaceRingExplosion(Entity ent, World world, Integer type, Double xCoord, Double yCoord, Double zCoord, Double xOffset, Double yOffset, Double zOffset, int radius, Integer height)
	{
		this.ent = ent;
		this.world = world;
		this.type = type;
	...
	public static class Handler implements IMessageHandler<PacketCarapaceRingExplosion, IMessage>
	{

		@Override
		public IMessage onMessage(PacketCarapaceRingExplosion message, MessageContext ctx) {
		...
		void processMessage(PacketCarapaceRingExplosion message, MessageContext ctx)
		{

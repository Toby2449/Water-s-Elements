...
public class PacketParticleCircleExplosion implements IMessage
{
	...
	public PacketParticleCircleExplosion()
	{
		this.messageValid = false;
	}
	
	public PacketParticleCircleExplosion(Entity ent, World world, Integer type, Double xCoord, Double yCoord, Double zCoord, Double xOffset, Double yOffset, Double zOffset, int radius, Integer height)
	{
		this.ent = ent;
		this.world = world;
		this.type = type;
	...
	public static class Handler implements IMessageHandler<PacketParticleCircleExplosion, IMessage>
	{

		@Override
		public IMessage onMessage(PacketParticleCircleExplosion message, MessageContext ctx) {
		...
		void processMessage(PacketParticleCircleExplosion message, MessageContext ctx)
		{

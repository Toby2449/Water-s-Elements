...
public class FireArmor extends ItemArmor implements IHasModel {

	public FireArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {

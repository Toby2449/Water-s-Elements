...
public class WaterArmor extends ItemArmor implements IHasModel {

	public WaterArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn)
	{
	    ...
	    list.add(I18n.format("tooltip.DrownImmunity"));
	    list.add(I18n.format("tooltip.WaterDamageReduction"));
	}

...
public class EMCoreBlocks 
{
	...
	public static final Block ORE_VOID_BEDROCK = new BlockVoidOre("ore_void_bedrock", EMCoreItems.VOIDESS, 1, 4, Material.ROCK, SoundType.STONE, 20.0f, 100.0f, "pickaxe", 3, 0.0f, 15, 5, 11);

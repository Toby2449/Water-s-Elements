...
public class EMCoreBlocks 
{
	...
	public static final Block ORE_VOID_BEDROCK = new BlockVoidOre("ore_void_bedrock", EMCoreItems.VOIDESS, 2, 6, Material.ROCK, SoundType.STONE, 70.0f, 100.0f, "pickaxe", 3, 0.0f, 15, 5, 11);

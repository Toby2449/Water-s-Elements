...
public class EmBlocks 
{
	...
	public static final Block ORE_VOID_BEDROCK = new BlockVoidOre("ore_void_bedrock", EmItems.VOIDESS, 1, 2, Material.ROCK, SoundType.STONE, 20.0f, 100.0f, "pickaxe", 3, 0.1f, 15, 5, 11);

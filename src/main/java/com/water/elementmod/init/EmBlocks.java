...
public class EmBlocks 
{
	...
	public static final Block ORE_VOID_BEDROCK = new OreBase("ore_void_bedrock", EmItems.VOIDESS, 1, 4, Material.ROCK, SoundType.STONE, 11.0f, 24.0f, "pickaxe", 1, 0.0f, 15);

...
public class EMSoundHandler {
	...
	public static void init()
	{
		...
		VE_WOUND_01 = registerSound("entity.ve_wound_01");
		VE_WOUND_02 = registerSound("entity.ve_wound_02");
		VE_WOUND_03 = registerSound("entity.ve_wound_03");
	}

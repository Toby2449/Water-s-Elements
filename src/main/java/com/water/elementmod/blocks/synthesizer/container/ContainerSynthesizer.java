...
public class ContainerSynthesizer extends Container
{
	...
	public ContainerSynthesizer(InventoryPlayer player, TileEntitySynthesizer tileentity)
	{
		...
		this.addSlotToContainer(new SlotSynthesizerFuel(tileentity, 2, 132, 10)); // fuel
		this.addSlotToContainer(new SlotSynthesizerOutput(player.player, tileentity, 3, 77, 34)); // output

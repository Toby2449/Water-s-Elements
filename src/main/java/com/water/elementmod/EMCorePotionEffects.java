...
public class EMCorePotionEffects 
{
	...
	public static final Potion POTION_GLIMPSE = new CustomPotionEffect("glimpse", true, 7348689, 1, 0);
	public static final Potion POTION_INSANITY = new CustomPotionEffect("insanity", true, 7348689, 2, 0);
}
